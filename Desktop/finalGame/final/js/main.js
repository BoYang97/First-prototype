...
GamePlay.prototype = {
	...
	create: function() {
		...
		this.wallTrap = new WallTrap(game, 6000, 1100, 'wallTrap', 0, this.player);
		game.add.existing(this.wallTrap);
		this.wallTrap2 = new WallTrap(game, 9000, 1100, 'wallTrap', 0, this.player); 
		...
		this.movingTrap5 = new movingtrap(game, 17100, 1050, 'barrier', 0, this.player, 4.5, 0.3);  
		game.add.existing(this.movingTrap5);
		this.movingTrap6 = new movingtrap(game, 18000, 1040, 'barrier', 0, this.player, 5, 0.3);  
		game.add.existing(this.movingTrap6);

		this.button6 = new Button(game, 16550, 1250, 'button', 0, this.player, this.mapLayer);  
		game.add.existing(this.button6);
		z6 = this.button6.y;
		this.button7 = new Button(game, 17460, 1250, 'button', 0, this.player, this.mapLayer);  
		game.add.existing(this.button7);
		z7 = this.button7.y;
		
		this.box7 = new Box(game, 16890, 400, 'box', 0, this.player);  
		game.add.existing(this.box7);
		this.box7.body.gravity.y = 0;

		this.box8 = new Box(game, 17760, 400, 'box', 0, this.player);  
		game.add.existing(this.box8);
		this.box8.body.gravity.y = 0;
		...
		this.movingTrap8 = new movingtrap(game, 19520, 950, 'barrier', 0, this.player, 1.5, 0.5, this.mapLayer);  
		...
		this.movingTrap10 = new movingtrap(game, 19960, 950, 'barrier', 0, this.player, 1.5, 0.5, this.mapLayer);  
	...
	/*checkOverlap: function(box3,box4){
		var bound1=box3.getBounds();
		var bound2=box4.getBounds();
		return Phaser.Rectangle.intersects(bound1, bound2);
	},

	checkOverlap1: function(box5,box4){
		var bound1=box5.getBounds();
		var bound2=box4.getBounds();
		return Phaser.Rectangle.intersects(bound1, bound2);
	},

	checkOverlap2: function(box5,box3){
		var bound1=box5.getBounds();
		var bound2=box3.getBounds();
		return Phaser.Rectangle.intersects(bound1, bound2);
	},*/
